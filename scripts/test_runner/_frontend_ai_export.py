"""Frontend AI Export V2 unit and hard-cutover E2E tests."""
...
AI_EXPORT_UNIT_TEST_PATHS = (
    ...
    "src/lib/features/ai-export/__tests__/aiExportClipboardV2.test.ts",
    ...
    "src/lib/features/ai-export/__tests__/promptRendererV2.test.ts",
...
def front_ai_export_cutover(verbose: bool = False, ui: bool = False, headed: bool = False, debug: bool = False, test_names: list = None, coverage: bool = False) -> bool:
    """Run the focused cross-domain AI Export V2 cutover E2E test."""
    print_section("Frontend AI Export V2 Cutover Tests")
...
def populate_registry(registry: dict) -> None:
    ...
    cat = make_category(
        help_text="Frontend AI Export V2 unit and cross-domain cutover E2E tests",
        description="""Frontend AI Export V2 Tests\n\nOptions: --ui, --headed, --debug""",
    )
    add_test(
        cat,
        "unit",
        ...
        desc="All nine AI Export and eight current signal Vitest files",
        tests="17 explicit Vitest files",
    )
    add_test(
        cat,
        "cutover",
        front_ai_export_cutover,
        name="AI Export V2 Cutover Tests",
