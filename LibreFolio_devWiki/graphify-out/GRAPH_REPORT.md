...
3. `F-047 — Transaction List Page` - 29 edges
...
7. `Unified Batch Pipeline — 2 endpoints replace 4` - 18 edges
8. `💱 FX Rates` - 17 edges
9. `💱 FX Rates` - 17 edges
...
Cohesion: 0.29
Nodes (10): Exact-Version Capability Probe, No vectorbt or Numba in Production, Numba 0.66, Numba 0.66 Requires numpy<2.5, NumPy 2.5.1 Baseline, Riskfolio 7.3.0 NumPy-vectorbt Dependency Trap, Python 3.13, Retained Riskfolio-Lib 7.0.1 Pin (+2 more)
...
Cohesion: 0.29
Nodes (6): 🚀 Asset Creation Flows, ➕ Create & Edit Assets, 🛠️ Editing an Asset, 🔌 Provider Assignment, 🔗 Related, 🧪 Testing Provider Configuration
