...
🔗 Règles complètes de mise à jour par courtier : **[Portfolio Engine — §6 Modèle de Cash à Trois Pools](index.md#6-three-pool-cash-model-per-broker-k_b-r_b-w)**

---

## 📝 Exemples Pratiques

### 🧾 — Dépôt → Achat → Vente avec Gain
...
🔗 Voir **[Portfolio Engine — §6](index.md#6-three-pool-cash-model-per-broker-k_b-r_b-w)** pour toutes les règles formelles.
