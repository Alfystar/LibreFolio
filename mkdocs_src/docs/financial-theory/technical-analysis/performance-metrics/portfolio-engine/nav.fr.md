...
🔗 Voir **[Portfolio Engine — §5 Aggregation](index.md#5-portfolio-aggregation)** pour la démonstration complète.
...
Le PMP n'est **jamais** utilisé pour la valorisation. Voir **[Portfolio Engine — §2](index.md#2-valuation-price)**.
