...
| <img src="https://www.intesasanpaolo.com/favicon.ico" alt="" style="width:16px;vertical-align:middle;margin-right:6px"> [**Intesa Sanpaolo**](../../../user/transactions/import/intesa.md) | `broker_intesa` | CSV, XLSX | 🧪 Beta | Italian bank; movements list (coupons/fees, unknown rows skipped) and portfolio snapshot seeded as deposit + per-holding adjustment. |
| <img src="https://www.credit-agricole.it/favicon.ico" alt="" style="width:16px;vertical-align:middle;margin-right:6px"> [**Crédit Agricole Italia**](../../../user/transactions/import/credit_agricole.md) | `broker_credit_agricole` | CSV, XLSX | 🧪 Beta | Italian bank; "Lista Movimenti Deposito Titoli". Succession transfers imported as adjustments (origin causale kept in description). |
