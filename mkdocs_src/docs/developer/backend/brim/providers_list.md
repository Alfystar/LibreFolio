...
| <img src="https://www.credit-agricole.it/favicon.ico" alt="" style="width:16px;vertical-align:middle;margin-right:6px"> [**Crédit Agricole Italia**](../../../user/transactions/import/credit_agricole.md) | `broker_credit_agricole` | CSV, XLSX | 🧪 Beta | Italian bank; "Lista Movimenti Deposito Titoli". Name-only asset IDs, auto cash counter-entries for buy/sell, bond maturity split, succession legs as cashless `ADJUSTMENT` with origin causale in description. |
